...
After approvals, TeamTreasury execution is permissionless for liveness: a relayer may submit the fixed call but cannot redirect or change the approved token, recipient, amount, or PaymentIntent hash.
